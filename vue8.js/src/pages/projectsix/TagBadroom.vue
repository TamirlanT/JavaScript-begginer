        ...
        <div class="product" v-for="project in projectList" :key="project.id">
            ...
            <div class="product__footer">
                ...
                <div class="product__button">
                    <button class="product__button"><img src="../../assets/projectssix/buttonRight.svg" alt="s"></button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    data() {
        return {
            projectList:
                [{
                    image: require("../../assets/projectssix/product1.jpg"),
                    title: 'Minimal Bathroom',
                    text: 'Decor / Arc',
                    id: 1,
                    isActive: false,
                }, {
                    image: require("../../assets/projectssix/product2.jpg"),
                    title: 'Minimal Bathroom',
                    text: 'Decor / Arc',
                    id: 2,
                    isActive: true,
                }, {
                    image: require("../../assets/projectssix/product3.jpg"),
                    title: 'Minimal Bathroom',
                    text: 'Decor / Arc',
                    id: 3,
                    isActive: false,
